...
/* First created by JCasGen Mon May 18 10:57:20 CDT 2015 */
...
/** 
 * Updated by JCasGen Mon May 18 10:57:20 CDT 2015
 * @generated */
public class DictMatch_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("clinicalnlp.dict.uima.DictMatch");
  ...
  public int getMatched(int addr) {
      ...
      jcas.throwFeatMissing("matched", "clinicalnlp.dict.uima.DictMatch");
  ...
  public String getCanonical(int addr) {
      ...
      jcas.throwFeatMissing("canonical", "clinicalnlp.dict.uima.DictMatch");
  ...
  public String getCode(int addr) {
      ...
      jcas.throwFeatMissing("code", "clinicalnlp.dict.uima.DictMatch");
  ...
  public String getVocabulary(int addr) {
      ...
      jcas.throwFeatMissing("vocabulary", "clinicalnlp.dict.uima.DictMatch");
  ...
  public int getContainer(int addr) {
      ...
      jcas.throwFeatMissing("container", "clinicalnlp.dict.uima.DictMatch");
